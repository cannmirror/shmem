...
UDMA_ATOMIC_FETCH_FUNC_TYPE(UDMA_ATOMIC_FETCH_ADD_TEST_KERNEL);
...
UDMA_ATOMIC_FETCH_FUNC_TYPE(UDMA_ATOMIC_FETCH_ADD_TEST);
...
UDMA_ATOMIC_FETCH_FUNC_TYPE(UDMA_ATOMIC_COMPARE_SWAP_TEST_KERNEL);
...
UDMA_ATOMIC_FETCH_FUNC_TYPE(UDMA_ATOMIC_COMPARE_SWAP_TEST);
